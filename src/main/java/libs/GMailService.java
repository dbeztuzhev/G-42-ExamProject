...
public class GMailService {
    ...
    public static void main(String[] args) {
        String messageSubject = "Invitation to Hideez Enterprise Server";
        String messageTo = "admhideeztest@gmail.com";
        String messageFrom = "hideezserver@gmail.com";
     ...
     */
    public GMailService(){
        this.user = "admhideeztest@gmail.com";
        this.pass = "Hideeztest2020";
    }
